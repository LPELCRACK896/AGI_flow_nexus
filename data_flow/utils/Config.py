...
class Config:
    def __init__(self, path, required_fields=[]) -> None:
        self.path = path
        self.__config = None
    ...
    def __get_envs(self):
        ...
        raise FileNotFoundError(f"The environment file at {self.path} was not found. TIP: your current path is {os.getcwd()}")
